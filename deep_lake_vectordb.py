...
def create_embeddings(review):
    ...
    dataset_name_vs = "review_db_final2"
    ...
    for i in range(len(embeddings_review)):
        ...
        vector_search.append({"embedding": np.array(embeddings_review[i]).reshape(1, -1), "product_name": ["AuraGlow Sleep Mask"], "review_context": [reviews[i]]})
